...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/GEN-RunIII2024Summer24NanoAODv15-00002/
...
# Dump actual test code to a GEN-RunIII2024Summer24NanoAODv15-00002_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > GEN-RunIII2024Summer24NanoAODv15-00002_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --scenario pp --era Run3_2024 --customise Configuration/DataProcessing/Utils.addMonitoring --step NANO --conditions 150X_mcRun3_2024_realistic_v2 --datatier NANOAODSIM --eventcontent NANOEDMAODSIM1 --python_filename GEN-RunIII2024Summer24NanoAODv15-00002_1_cfg.py --fileout file:GEN-RunIII2024Summer24NanoAODv15-00002.root --filein "dbs:/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/RunIII2024Summer24MiniAODv6-150X_mcRun3_2024_realistic_v2-v3/MINIAODSIM" --number 2000 --number_out 2000 --no_exec --mc || exit $? ;

# End of GEN-RunIII2024Summer24NanoAODv15-00002_test.sh file
EndOfTestFile

# Make file executable
chmod +x GEN-RunIII2024Summer24NanoAODv15-00002_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/GEN-RunIII2024Summer24NanoAODv15-00002_test.sh)
