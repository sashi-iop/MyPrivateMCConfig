...
# 2. Output Paths
EOS_BASE="/eos/user/s/sasahoo/MC_Production/HWZTo3L_5f_TuneCP5_13p6TeV_madgraph-pythia8"
...
cmsDriver.py Configuration/GenProduction/python/HWZ_LO_fragment.py \
  ...
  --fileout file:${EOS_BASE}/GENSIM/HWZTo4L_5f_Run3Summer24-GENSIM-140X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:2024v14 --era Run3_2024 \
  ...
  --filein file:${EOS_BASE}/GENSIM/HWZTo4L_5f_Run3Summer24-GENSIM-140X_v1.root \
  --fileout file:${EOS_BASE}/DIGI/HWZTo4L_5f_Run3Summer24-DIGI-140X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py --step RAW2DIGI,L1Reco,RECO,RECOSIM --era Run3_2024 \
  ...
  --filein file:${EOS_BASE}/DIGI/HWZTo4L_5f_Run3Summer24-DIGI-140X_v1.root \
  --fileout file:${EOS_BASE}/AODSIM/HWZTo4L_5f_Run3Summer24-AODSIM-140X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py --era Run3_2024 --customise Configuration/DataProcessing/Utils.addMonitoring \
  ...
  --filein file:${EOS_BASE}/AODSIM/HWZTo4L_5f_Run3Summer24-AODSIM-140X_v1.root \
  --fileout file:${EOS_BASE}/MINIAODSIM/HWZTo4L_5f_Run3Summer24-MINIAODSIM-150X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py --scenario pp --era Run3_2024 \
  ...
  --filein file:${EOS_BASE}/MINIAODSIM/HWZTo4L_5f_Run3Summer24-MINIAODSIM-150X_v1.root \
  --fileout file:${EOS_BASE}/NANOAODSIM/HWZTo4L_5f_Run3Summer24-NANOAODSIM-150X_v1.root \
  --number 5 --no_exec --mc
cmsRun HWZ_5f_NanoAOD_cfg.py

echo "=== 5-Flavor Local Pipeline Successfully Finished! ==="
