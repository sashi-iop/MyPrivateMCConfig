This guide adapts official CMS dataset naming standards directly into your local directory structures and filenames, ensuring your samples remain self-documenting and easy to distinguish from 4-flavor runs.
...
```text
/eos/user/s/sasahoo/MC_Production/HWZTo3L_5f_TuneCP5_13p6TeV_madgraph-pythia8/
├── GENSIM/
│   └── HWZTo4L_5f_Run3Summer24-GENSIM-140X_v1.root
├── DIGI/
│   └── HWZTo4L_5f_Run3Summer24-DIGI-140X_v1.root
├── AODSIM/
│   └── HWZTo4L_5f_Run3Summer24-AODSIM-140X_v1.root
├── MINIAODSIM/
│   └── HWZTo4L_5f_Run3Summer24-MINIAODSIM-150X_v1.root
└── NANOAODSIM/
    └── HWZTo4L_5f_Run3Summer24-NANOAODSIM-150X_v1.root
...
# Advisible to use the absolute path of the gridpack
...
cmsDriver.py Configuration/GenProduction/python/HWZ_LO_fragment.py \
  ...
  --fileout file:${EOS_OUT}/GENSIM/HWZTo4L_5f_Run3Summer24-GENSIM-140X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py \
  ...
  --filein file:${EOS_OUT}/GENSIM/HWZTo4L_5f_Run3Summer24-GENSIM-140X_v1.root \
  --fileout file:${EOS_OUT}/DIGI/HWZTo4L_5f_Run3Summer24-DIGI-140X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py \
  ...
  --filein file:${EOS_OUT}/DIGI/HWZTo4L_5f_Run3Summer24-DIGI-140X_v1.root \
  --fileout file:${EOS_OUT}/AODSIM/HWZTo4L_5f_Run3Summer24-AODSIM-140X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py \
  ...
  --filein file:${EOS_OUT}/AODSIM/HWZTo4L_5f_Run3Summer24-AODSIM-140X_v1.root \
  --fileout file:${EOS_OUT}/MINIAODSIM/HWZTo4L_5f_Run3Summer24-MINIAODSIM-150X_v1.root \
  --number 5 --no_exec --mc
...
cmsDriver.py \
  ...
  --filein file:${EOS_OUT}/MINIAODSIM/HWZTo4L_5f_Run3Summer24-MINIAODSIM-150X_v1.root \
  --fileout file:${EOS_OUT}/NANOAODSIM/HWZTo4L_5f_Run3Summer24-NANOAODSIM-150X_v1.root \
  --number 5 --no_exec --mc
