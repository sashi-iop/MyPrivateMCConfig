...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/GEN-RunIII2024Summer24DRPremix-00003/
...
# Dump actual test code to a GEN-RunIII2024Summer24DRPremix-00003_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > GEN-RunIII2024Summer24DRPremix-00003_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --conditions 140X_mcRun3_2024_realistic_v26 --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:2024v14 --procModifiers premix_stage2 --geometry DB:Extended --datamix PreMix --era Run3_2024 --python_filename GEN-RunIII2024Summer24DRPremix-00003_1_cfg.py --fileout file:GEN-RunIII2024Summer24DRPremix-00003_0.root --filein file:GEN-RunIII2024Summer24wmLHEGS-00006.root --number 100 --number_out 100 --pileup_input "dbs:/Neutrino_E-10_gun/RunIIISummer24PrePremix-Premixlib2024_140X_mcRun3_2024_realistic_v26-v1/PREMIX" --no_exec --mc || exit $? ;

# cmsDriver command
cmsDriver.py  --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --conditions 140X_mcRun3_2024_realistic_v26 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --era Run3_2024 --python_filename GEN-RunIII2024Summer24DRPremix-00003_2_cfg.py --fileout file:GEN-RunIII2024Summer24DRPremix-00003.root --filein file:GEN-RunIII2024Summer24DRPremix-00003_0.root --number 100 --number_out 100 --no_exec --mc || exit $? ;

# End of GEN-RunIII2024Summer24DRPremix-00003_test.sh file
EndOfTestFile

# Make file executable
chmod +x GEN-RunIII2024Summer24DRPremix-00003_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/GEN-RunIII2024Summer24DRPremix-00003_test.sh)
